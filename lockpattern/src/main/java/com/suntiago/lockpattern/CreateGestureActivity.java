...
import com.suntiago.lockpattern.util.ACache;
import com.suntiago.lockpattern.util.LockPatternUtil;
import com.suntiago.lockpattern.widget.LockPatternIndicator;
import com.suntiago.lockpattern.widget.LockPatternView;

import java.util.ArrayList;
import java.util.List;

import static com.suntiago.lockpattern.PatternManager.GESTURE_PASSWORD;
        ...
        public void onPatternComplete(List<LockPatternView.Cell> pattern) {
            ...
            if (mChosenPattern == null && pattern.size() >= 4) {
                ...
                if (mChosenPattern.equals(pattern)) {
                    ...
                    PatternManager.gett().patternSet();
                } else {
